 ...
 * @author mambou & Paez
 */
public class Cliffs implements Serializable{
    ...
    public String toString() {
        return "Cliffs{" + "description=" + description + ", amountAvailable=" + amountAvailable + ", resources=" + resources + '}';
    }
    ...
    public int hashCode() {
        ...
        hash = 59 * hash + Objects.hashCode(this.resources);
        return hash;
    }
